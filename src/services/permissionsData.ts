...
export const ALL_PERMISSIONS: Permission[] = [
  ...
  // Money In
  { id: 'p33', code: 'money_in.view', module: 'Receipt from Client', name: 'View Receipts', description: 'View client receipts and collections' },
  { id: 'p34', code: 'money_in.create', module: 'Receipt from Client', name: 'Create Receipts', description: 'Record inbound money receipt' },
  { id: 'p35', code: 'money_in.edit', module: 'Receipt from Client', name: 'Edit Receipts', description: 'Modify receipt before posting' },
  { id: 'p36', code: 'money_in.submit', module: 'Receipt from Client', name: 'Submit Receipts', description: 'Submit receipt for approval' },
  { id: 'p37', code: 'money_in.approve', module: 'Receipt from Client', name: 'Approve Receipts', description: 'Approve money receipts' },
  { id: 'p38', code: 'money_in.post', module: 'Receipt from Client', name: 'Post Receipts', description: 'Post money receipt to cash/bank' },
  { id: 'p39', code: 'money_in.reverse', module: 'Receipt from Client', name: 'Reverse Receipts', description: 'Reverse receipt transaction' },
  { id: 'p40', code: 'money_in.export', module: 'Receipt from Client', name: 'Export Receipts', description: 'Export receipts' },
  {
    id: 'p92',
    code: 'money_in.import',
    module: 'Receipt from Client',
    name: 'Import Receipts',
    description: 'Bulk-import Receipt from Client transactions from Excel, including filling in missing fields on already-posted records (Super Administrator only by default)',
  },

  // Money Out
  { id: 'p41', code: 'money_out.view', module: 'Payment to Vendors', name: 'View Payments', description: 'View vendor and supplier payments' },
  { id: 'p42', code: 'money_out.create', module: 'Payment to Vendors', name: 'Create Payments', description: 'Record outbound payment' },
  { id: 'p43', code: 'money_out.edit', module: 'Payment to Vendors', name: 'Edit Payments', description: 'Edit payment details' },
  { id: 'p44', code: 'money_out.submit', module: 'Payment to Vendors', name: 'Submit Payments', description: 'Submit payment for approval' },
  { id: 'p45', code: 'money_out.approve', module: 'Payment to Vendors', name: 'Approve Payments', description: 'Approve outbound payments' },
  { id: 'p46', code: 'money_out.post', module: 'Payment to Vendors', name: 'Post Payments', description: 'Post payment' },
  { id: 'p47', code: 'money_out.reverse', module: 'Payment to Vendors', name: 'Reverse Payments', description: 'Reverse payment transaction' },
  { id: 'p48', code: 'money_out.export', module: 'Payment to Vendors', name: 'Export Payments', description: 'Export payments' },
  {
    id: 'p93',
    code: 'money_out.import',
    module: 'Payment to Vendors',
    name: 'Import Payments',
    description: 'Bulk-import Payment to Vendors transactions from Excel, including filling in missing fields on already-posted records (Super Administrator only by default)',
  },
