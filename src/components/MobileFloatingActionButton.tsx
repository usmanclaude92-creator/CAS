    ...
    <>
      ...
      <div className="fixed bottom-20 right-4 z-40 lg:hidden print:hidden flex flex-col items-end">
              ...
              <div className="grid grid-cols-1 gap-1 pt-1 max-h-[60vh] overflow-y-auto">
                {actionItems.map((item) => (
                  <button
                    ...
                    className={`btn-press ripple-effect flex items-center gap-3 p-2.5 rounded-xl border text-left transition-all active:scale-98 cursor-pointer ${item.bg}`}
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] font-medium text-slate-500 dark:text-slate-400 opacity-90 text-right">
                          {item.urduHint}
                        </span>
                      </div>
        ...
        <button
          ...
          className={`btn-press ripple-effect w-14 h-14 rounded-full shadow-[0_8px_24px_rgba(79,70,229,0.35)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.6)] flex items-center justify-center transition-all duration-200 active:scale-90 cursor-pointer ${
            isOpen
